...
public class JsonObjectTest {
    ...
    public void testPutAndGet() throws JsonValueParseException, InstantiationException, IllegalAccessException, ClassNotFoundException, RequiredFieldNotFoundException, InvalidParameterValueException {
        ...
        Assert.assertEquals(1, (byte)jsonObj.getByte(numKey));
        Assert.assertEquals(1, (short)jsonObj.getShort(numKey));
        Assert.assertEquals(1, (int)jsonObj.getInt(numKey));
        Assert.assertEquals(1, (long)jsonObj.getLong(numKey));
    ...
    public void testNewStringConstructor() throws JsonValueParseException {
        ...
        Assert.assertEquals(12, (int)jsonObject.getInt("age"));
    }
}
